...
public class SeekingArrowRenderer extends EntityRenderer<SeekingArrowEntity> {
	private static final ResourceLocation texture = new ResourceLocation("benssharks:textures/entities/seekingarrow.png");
	private final ModelSeekingArrow model;

	public SeekingArrowRenderer(EntityRendererProvider.Context context) {
		super(context);
		model = new ModelSeekingArrow(context.bakeLayer(ModelSeekingArrow.LAYER_LOCATION));
	}
