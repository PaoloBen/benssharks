...
public class ThalassogerEntity extends Raider implements RangedAttackMob, GeoEntity {
	...
	public ThalassogerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(BenssharksModEntities.THALASSOGER.get(), world);
	}
	...
	public class RangedAttackGoal extends Goal {
		...
		public void tick() {
			...
			if (--this.attackTime == 0) {
				...
				((ThalassogerEntity) rangedAttackMob).entityData.set(SHOOT, true);
	...
	public SoundEvent getCelebrateSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("entity.evoker.celebrate"));
	}
	...
	public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
		...
		ThalassogerThisEntityKillsAnotherOneProcedure.execute();
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 20) {
			this.remove(ThalassogerEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
