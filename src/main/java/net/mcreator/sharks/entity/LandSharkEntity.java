...
public class LandSharkEntity extends TamableAnimal implements GeoEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new FollowOwnerGoal(this, 1, (float) 16, (float) 2, false) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(14, new FollowMobGoal(this, 1, (float) 64, (float) 5) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(15, new AvoidEntityGoal<>(this, Dolphin.class, (float) 128, 1, 1.2) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(16, new AvoidEntityGoal<>(this, ShrakEntity.class, (float) 128, 1, 1.2) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(17, new AvoidEntityGoal<>(this, TigerSharkEntity.class, (float) 128, 1, 1.2) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(18, new AvoidEntityGoal<>(this, MakoSharkEntity.class, (float) 128, 1, 1.2) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(19, new AvoidEntityGoal<>(this, RemoraEntity.class, (float) 128, 1, 1.2) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(20, new AvoidEntityGoal<>(this, Drowned.class, (float) 128, 1, 1.2) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
		...
		this.goalSelector.addGoal(21, new AvoidEntityGoal<>(this, AxodileEntity.class, (float) 128, 1, 1.2) {
			@Override
			public boolean canUse() {
				double x = LandSharkEntity.this.getX();
				double y = LandSharkEntity.this.getY();
	...
	public InteractionResult mobInteract(Player sourceentity, InteractionHand hand) {
		...
		LandSharkRightClickedOnEntityProcedure.execute(entity, sourceentity);
		return retval;
	}
