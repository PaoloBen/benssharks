...
public class SharkPlushieTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public SharkPlushieTileEntity(BlockPos pos, BlockState state) {
		super(BenssharksModBlockEntities.SHARK_PLUSH_BLOCK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(SharkPlushieBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<SharkPlushieTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<SharkPlushieTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("shark_plush_block");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Shark Plush");
	}
