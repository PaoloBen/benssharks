...
public class SeekerSharkProjectileProjectileHitsPlayerProcedure {
	public static void execute(LevelAccessor world, Entity entity, Entity immediatesourceentity) {
		...
		if (!(entity instanceof Player _plr ? _plr.getAbilities().instabuild : false)) {
			...
			} else if (entity instanceof LivingEntity _livEnt31 && _livEnt31.isBlocking() && (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == Items.SHIELD) {
				{
