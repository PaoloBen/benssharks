...
public class PilotFishBucketRightclickedOnBlockProcedure {
			...
			if (direction == Direction.UP && ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == Blocks.WATER || (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == Blocks.WATER
				...
				if (!world.isClientSide()) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = BenssharksModEntities.PILOT_FISH.get().spawn(_level, BlockPos.containing(x + 0.5, y + 1, z + 0.5), MobSpawnType.MOB_SUMMONED);
						if (entityToSpawn != null) {
							entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
						}
					}
					if (!(itemstack.getDisplayName().getString()).equals("[Bucket of Pilot Fish]") && !world.getEntitiesOfClass(PilotFishEntity.class, AABB.ofSize(new Vec3(x, y, z), 6, 6, 6), e -> true).isEmpty()) {
						((Entity) world.getEntitiesOfClass(PilotFishEntity.class, AABB.ofSize(new Vec3(x, y, z), 6, 6, 6), e -> true).stream().sorted(new Object() {
				...
				}.checkGamemode(entity)) == false && (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == BenssharksModItems.PILOT_FISH_BUCKET.get()) {
					if (entity instanceof LivingEntity _entity)
						_entity.swing(InteractionHand.MAIN_HAND, true);
				...
				}.checkGamemode(entity)) == false && (entity instanceof LivingEntity _livEnt ? _livEnt.getOffhandItem() : ItemStack.EMPTY).getItem() == BenssharksModItems.PILOT_FISH_BUCKET.get()) {
					if (entity instanceof LivingEntity _entity)
				...
				if (!world.isClientSide()) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = BenssharksModEntities.PILOT_FISH.get().spawn(_level, BlockPos.containing(x + 0.5, y, z - 0.5), MobSpawnType.MOB_SUMMONED);
						if (entityToSpawn != null) {
							entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
						}
					}
				...
				if (!world.isClientSide()) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = BenssharksModEntities.PILOT_FISH.get().spawn(_level, BlockPos.containing(x + 1.5, y, z + 0.5), MobSpawnType.MOB_SUMMONED);
						if (entityToSpawn != null) {
							entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
						}
					}
				...
				if (!world.isClientSide()) {
					if (world instanceof ServerLevel _level) {
						Entity entityToSpawn = BenssharksModEntities.PILOT_FISH.get().spawn(_level, BlockPos.containing(x + 0.5, y, z + 1.5), MobSpawnType.MOB_SUMMONED);
						if (entityToSpawn != null) {
							entityToSpawn.setYRot(world.getRandom().nextFloat() * 360F);
						}
					}
