...
public class CookiecutterSharkRightClickedOnEntityProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		String nametag = "";
		String uuid = "";
		if (entity instanceof CookiecutterSharkEntity && !(entity instanceof LivingEntity _livEnt1 && _livEnt1.isBaby()) && sourceentity instanceof Player) {
			...
			if ((sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Items.WATER_BUCKET) {
				...
				if (sourceentity instanceof LivingEntity _entity) {
					ItemStack _setstack = new ItemStack(BenssharksModItems.COOKIECUTTER_SHARK_BUCKET.get()).copy();
