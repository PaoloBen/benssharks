...
public class GoblinSharkEntityIsHurtProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (entity instanceof GoblinSharkEntity && entity.isInWaterOrBubble()) {
			if (entity instanceof GoblinSharkEntity) {
				((GoblinSharkEntity) entity).setAnimation("sprint");
			}
			...
			BenssharksMod.queueServerWork(600, () -> {
				...
				if (entity instanceof GoblinSharkEntity) {
					((GoblinSharkEntity) entity).setAnimation("empty");
				}
			});
		}
	}
